...
#define INIT__() Pm_Controller cont(    \
    "D:/TemporaryFiles/Post-Machine-Emulator/unit_tests/input_files/SYMBOLS",                        \
    "D:/TemporaryFiles/Post-Machine-Emulator/unit_tests/input_files/VARIABLES",                      \
    "D:/TemporaryFiles/Post-Machine-Emulator/unit_tests/input_files/AXIOMS",                         \
    "D:/TemporaryFiles/Post-Machine-Emulator/unit_tests/input_files/RULES")
...
TEST( get_journal, File_input ) {
    INIT__();
    bool flag = true;
    const list<Pm_Record>& reclist = cont.get_journal("D:/TemporaryFiles/Post-Machine-Emulator/unit_tests/input_files/MYINPUT");
    auto it = reclist.begin();
    flag *= (it->after.compare("111*11=111") == 0); it++;
    flag *= (it->after.compare("11*11=11111") == 0); it++;
    flag *= (it->after.compare("1*11=1111111") == 0); it++;
